<?php get_header(); ?>
	...
	<div class="wrapper">
	    	<section class="clearfix header-pages">
				<h1><span>The midas</span> <?php wp_title(); ?></h1>
				<p><?php the_field('header_line_1', get_option('page_for_posts')); ?></p>
				<p><?php the_field('header_line_2', get_option('page_for_posts')); ?></p>
			</section><!-- Promo -->
